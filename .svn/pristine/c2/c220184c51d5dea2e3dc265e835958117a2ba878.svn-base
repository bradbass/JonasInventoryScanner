...
class Mail extends javax.mail.Authenticator {
	...
	/**
	 * @param user      mail account username
	 * @param pass      mail account password
	 */
	...
	/**
	 * @return          returns if message sent.
	 * @throws Exception
	 */
	...
	/**
	 * @param path          path to the upload file.
